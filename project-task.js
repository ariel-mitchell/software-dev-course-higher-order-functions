...
*/
let uppercaseProductNames = products.map(product => {
  return {
...
function applyDiscount(discount) {
  return function (product) {
    return { ...product, price: product.price-(product.price*discount*.01)}
  } 
}
...
*/
let totalPriceOfAvailable = products.reduce((total, product) => {
...
console.log("Total value in stock:", totalPriceOfAvailable);
